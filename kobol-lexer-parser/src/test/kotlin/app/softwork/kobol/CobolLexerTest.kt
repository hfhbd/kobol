    ...
    fun string() {
        ...
        assertEquals(
            listOf(
                ...
                WHITE_SPACE, WHITE_SPACE, MOVE, WHITE_SPACE, STRING, WHITE_SPACE, TO, WHITE_SPACE, VARNAME, WHITE_SPACE,
                WHITE_SPACE, WHITE_SPACE, DISPLAY_LITERAL, WHITE_SPACE, STRING, DOT
            ),
            all
        )
    }
    ...
    fun workingSection() {
        ...
        assertEquals(
            listOf(
                ...
                WHITE_SPACE, WHITE_SPACE, SA_LITERAL, WHITE_SPACE, VARNAME, WHITE_SPACE, PIC_LITERAL, WHITE_SPACE, PIC_S, PIC_9, LP, NUMBER, RP, WHITE_SPACE, VALUE, WHITE_SPACE, NUMBER, DOT, WHITE_SPACE,
                WHITE_SPACE, WHITE_SPACE, RECORD_01, WHITE_SPACE, VARNAME, DOT, WHITE_SPACE,
