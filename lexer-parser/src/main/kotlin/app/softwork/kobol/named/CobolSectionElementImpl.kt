...
internal abstract class CobolSectionElementImpl(
    node: ASTNode,
) : ASTWrapperPsiElement(node), CobolNamedElement, CobolSectionID {
    ...
    override fun getReference(): CobolSectionReference? = if (parent is CobolProcedureSection) {
        null
    } else {
